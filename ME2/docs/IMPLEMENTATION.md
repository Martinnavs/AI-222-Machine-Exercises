# ME2 — Implementation Details

Full technical writeup for the CosyVoice 2 zero-shot TTS spike. For the short, human-readable
overview, see `../README.md` — this doc is the deep-dive companion, moved here so the top-level
README can stay skimmable.
