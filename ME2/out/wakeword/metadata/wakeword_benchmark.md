...
Window: 1.5s (151 log-mel frames). onnxruntime threads: intra_op=1, inter_op=1. Checkpoint: `out/wakeword/checkpoints/checkpoint.pt` (preset=default).
...
|---|---|---|---|---|---|---|
| fp32 ONNX | 0.119 | 0.256 | 0.267 | 442.711 | 0 | AMD EPYC 7742 (256-thread node) estimate |
| INT8 ONNX (static, val-calibrated) | 0.047 | 0.148 | 0.181 | 478.711 | 0 | AMD EPYC 7742 (256-thread node) estimate |
